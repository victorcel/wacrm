...
const SPEC_DEFAULT_STAGES = [
  ...
  { name: "Cualificado", color: "#eab308", position: 1 }, // yellow
      ...
      {pipelines.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border py-20">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Crea un embudo para empezar a gestionar negocios
          </p>
          <GatedButton
            canAct={canEditSettings}
            gateReason="crear embudos"
        ...
        <DialogContent className="sm:max-w-sm bg-popover border-border">
          ...
          <div className="py-2">
            ...
            <Input
              ...
              placeholder="p. ej., Ventas Enterprise"
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Se crearán automáticamente etapas por defecto (Nuevo lead → Ganado).
            </p>
          </div>
