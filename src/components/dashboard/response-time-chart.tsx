      ...
      <header className="flex items-center justify-between gap-3 border-b border-border px-5 py-4">
        <div>
          ...
          <p className="mt-0.5 text-xs text-muted-foreground">
            Minutos para responder al primer mensaje sin contestar de un
            cliente, por día de la semana
          </p>
        </div>
      ...
      <div className="p-5">
        {loading || !data ? (
          ...
          <EmptyState
            ...
            hint="Este gráfico se completa a medida que respondes a los mensajes de los clientes."
          />
        ) : (
          <BarChart
            data={chartData}
